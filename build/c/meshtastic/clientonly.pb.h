...
#define meshtastic_DeviceProfile_init_default    {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, meshtastic_LocalConfig_init_default, false, meshtastic_LocalModuleConfig_init_default, false, meshtastic_Position_init_default, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_DeviceProfile_init_zero       {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, meshtastic_LocalConfig_init_zero, false, meshtastic_LocalModuleConfig_init_zero, false, meshtastic_Position_init_zero, {{NULL}, NULL}, {{NULL}, NULL}}
...
X(a, CALLBACK, OPTIONAL, STRING,   long_name,         1) \
X(a, CALLBACK, OPTIONAL, STRING,   short_name,        2) \
...
X(a, CALLBACK, OPTIONAL, STRING,   ringtone,          7) \
X(a, CALLBACK, OPTIONAL, STRING,   canned_messages,   8)
