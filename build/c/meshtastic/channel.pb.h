...
#define meshtastic_ChannelSettings_init_default  {0, {{NULL}, NULL}, {{NULL}, NULL}, 0, 0, 0, false, meshtastic_ModuleSettings_init_default}
#define meshtastic_ModuleSettings_init_default   {0, 0}
#define meshtastic_Channel_init_default          {0, false, meshtastic_ChannelSettings_init_default, _meshtastic_Channel_Role_MIN}
#define meshtastic_ChannelSettings_init_zero     {0, {{NULL}, NULL}, {{NULL}, NULL}, 0, 0, 0, false, meshtastic_ModuleSettings_init_zero}
...
/* meshtastic_ChannelSettings_size depends on runtime parameters */
/* meshtastic_Channel_size depends on runtime parameters */
#define MESHTASTIC_MESHTASTIC_CHANNEL_PB_H_MAX_SIZE meshtastic_ModuleSettings_size
