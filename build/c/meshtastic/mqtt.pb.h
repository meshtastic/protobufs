...
#define meshtastic_ServiceEnvelope_init_default  {false, meshtastic_MeshPacket_init_default, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_MapReport_init_default        {{{NULL}, NULL}, {{NULL}, NULL}, _meshtastic_Config_DeviceConfig_Role_MIN, _meshtastic_HardwareModel_MIN, {{NULL}, NULL}, _meshtastic_Config_LoRaConfig_RegionCode_MIN, _meshtastic_Config_LoRaConfig_ModemPreset_MIN, 0, 0, 0, 0, 0, 0, 0}
#define meshtastic_ServiceEnvelope_init_zero     {false, meshtastic_MeshPacket_init_zero, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_MapReport_init_zero           {{{NULL}, NULL}, {{NULL}, NULL}, _meshtastic_Config_DeviceConfig_Role_MIN, _meshtastic_HardwareModel_MIN, {{NULL}, NULL}, _meshtastic_Config_LoRaConfig_RegionCode_MIN, _meshtastic_Config_LoRaConfig_ModemPreset_MIN, 0, 0, 0, 0, 0, 0, 0}
...
#define meshtastic_ServiceEnvelope_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   long_name,         1) \
X(a, CALLBACK, SINGULAR, STRING,   short_name,        2) \
X(a, STATIC,   SINGULAR, UENUM,    role,              3) \
X(a, STATIC,   SINGULAR, UENUM,    hw_model,          4) \
X(a, CALLBACK, SINGULAR, STRING,   firmware_version,   5) \
...
#define meshtastic_MapReport_CALLBACK pb_default_field_callback
...
/* meshtastic_MapReport_size depends on runtime parameters */
