...
#if defined(meshtastic_Config_DeviceConfig_size) && defined(meshtastic_Config_NetworkConfig_size) && defined(meshtastic_Config_LoRaConfig_size) && defined(meshtastic_Config_SecurityConfig_size)
#define meshtastic_LocalConfig_size              (199 + meshtastic_Config_DeviceConfig_size + meshtastic_Config_NetworkConfig_size + meshtastic_Config_LoRaConfig_size + meshtastic_Config_SecurityConfig_size)
#endif
#if defined(meshtastic_ModuleConfig_MQTTConfig_size) && defined(meshtastic_ModuleConfig_CannedMessageConfig_size) && defined(meshtastic_ModuleConfig_RemoteHardwareConfig_size) && defined(meshtastic_ModuleConfig_DetectionSensorConfig_size)
#define MESHTASTIC_MESHTASTIC_LOCALONLY_PB_H_MAX_SIZE meshtastic_LocalModuleConfig_size
#define meshtastic_LocalModuleConfig_size        (310 + meshtastic_ModuleConfig_MQTTConfig_size + meshtastic_ModuleConfig_CannedMessageConfig_size + meshtastic_ModuleConfig_RemoteHardwareConfig_size + meshtastic_ModuleConfig_DetectionSensorConfig_size)
#endif
