...
#define meshtastic_UserLite_init_default         {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, _meshtastic_HardwareModel_MIN, 0, _meshtastic_Config_DeviceConfig_Role_MIN, {{NULL}, NULL}, false, 0}
...
#define meshtastic_DeviceState_init_default      {false, meshtastic_MyNodeInfo_init_default, false, meshtastic_User_init_default, {{NULL}, NULL}, false, meshtastic_MeshPacket_init_default, 0, 0, 0, false, meshtastic_MeshPacket_init_default, {{NULL}, NULL}}
#define meshtastic_NodeDatabase_init_default     {0, {0}}
#define meshtastic_ChannelFile_init_default      {{{NULL}, NULL}, 0}
...
#define meshtastic_UserLite_init_zero            {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, _meshtastic_HardwareModel_MIN, 0, _meshtastic_Config_DeviceConfig_Role_MIN, {{NULL}, NULL}, false, 0}
...
#define meshtastic_DeviceState_init_zero         {false, meshtastic_MyNodeInfo_init_zero, false, meshtastic_User_init_zero, {{NULL}, NULL}, false, meshtastic_MeshPacket_init_zero, 0, 0, 0, false, meshtastic_MeshPacket_init_zero, {{NULL}, NULL}}
#define meshtastic_NodeDatabase_init_zero        {0, {0}}
#define meshtastic_ChannelFile_init_zero         {{{NULL}, NULL}, 0}
...
X(a, CALLBACK, SINGULAR, BYTES,    macaddr,           1) \
...
X(a, CALLBACK, SINGULAR, BYTES,    public_key,        7) \
...
X(a, CALLBACK, REPEATED, MESSAGE,  receive_queue,     5) \
X(a, STATIC,   OPTIONAL, MESSAGE,  rx_text_message,   7) \
X(a, STATIC,   SINGULAR, UINT32,   version,           8) \
X(a, STATIC,   SINGULAR, BOOL,     no_save,           9) \
X(a, STATIC,   SINGULAR, BOOL,     did_gps_reset,    11) \
X(a, STATIC,   OPTIONAL, MESSAGE,  rx_waypoint,      12) \
X(a, CALLBACK, REPEATED, MESSAGE,  node_remote_hardware_pins,  13)
#define meshtastic_DeviceState_CALLBACK pb_default_field_callback
...
#define meshtastic_ChannelFile_CALLBACK pb_default_field_callback
...
/* meshtastic_ChannelFile_size depends on runtime parameters */
/* meshtastic_BackupPreferences_size depends on runtime parameters */
#define MESHTASTIC_MESHTASTIC_DEVICEONLY_PB_H_MAX_SIZE meshtastic_PositionLite_size
