...
#define meshtastic_ChannelSet_init_default       {{{NULL}, NULL}, false, meshtastic_Config_LoRaConfig_init_default}
#define meshtastic_ChannelSet_init_zero          {{{NULL}, NULL}, false, meshtastic_Config_LoRaConfig_init_zero}
...
#define meshtastic_ChannelSet_CALLBACK pb_default_field_callback
...
/* meshtastic_ChannelSet_size depends on runtime parameters */
