...
#define meshtastic_InterdeviceMessage_init_default {0, {{{NULL}, NULL}}}
#define meshtastic_SensorData_init_zero          {_meshtastic_MessageType_MIN, 0, {0}}
#define meshtastic_InterdeviceMessage_init_zero  {0, {{{NULL}, NULL}}}
...
X(a, CALLBACK, ONEOF,    STRING,   (data,nmea,data.nmea),   1) \
X(a, STATIC,   ONEOF,    MESSAGE,  (data,sensor,data.sensor),   2)
#define meshtastic_InterdeviceMessage_CALLBACK pb_default_field_callback
...
/* meshtastic_InterdeviceMessage_size depends on runtime parameters */
#define MESHTASTIC_MESHTASTIC_INTERDEVICE_PB_H_MAX_SIZE meshtastic_SensorData_size
