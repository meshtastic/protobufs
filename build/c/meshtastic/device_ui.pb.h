...
typedef struct _meshtastic_DeviceUIConfig {
    ...
    pb_callback_t calibration_data;
    /* Map related data */
    bool has_map_data;
...
#define meshtastic_DeviceUIConfig_init_default   {0, 0, 0, 0, 0, 0, _meshtastic_Theme_MIN, 0, 0, 0, _meshtastic_Language_MIN, false, meshtastic_NodeFilter_init_default, false, meshtastic_NodeHighlight_init_default, {{NULL}, NULL}, false, meshtastic_Map_init_default, _meshtastic_CompassMode_MIN, 0, 0, _meshtastic_DeviceUIConfig_GpsCoordinateFormat_MIN}
#define meshtastic_NodeFilter_init_default       {0, 0, 0, 0, 0, {{NULL}, NULL}, 0}
#define meshtastic_NodeHighlight_init_default    {0, 0, 0, 0, {{NULL}, NULL}}
#define meshtastic_GeoPoint_init_default         {0, 0, 0}
#define meshtastic_Map_init_default              {false, meshtastic_GeoPoint_init_default, {{NULL}, NULL}, 0}
#define meshtastic_DeviceUIConfig_init_zero      {0, 0, 0, 0, 0, 0, _meshtastic_Theme_MIN, 0, 0, 0, _meshtastic_Language_MIN, false, meshtastic_NodeFilter_init_zero, false, meshtastic_NodeHighlight_init_zero, {{NULL}, NULL}, false, meshtastic_Map_init_zero, _meshtastic_CompassMode_MIN, 0, 0, _meshtastic_DeviceUIConfig_GpsCoordinateFormat_MIN}
#define meshtastic_NodeFilter_init_zero          {0, 0, 0, 0, 0, {{NULL}, NULL}, 0}
#define meshtastic_NodeHighlight_init_zero       {0, 0, 0, 0, {{NULL}, NULL}}
#define meshtastic_GeoPoint_init_zero            {0, 0, 0}
#define meshtastic_Map_init_zero                 {false, meshtastic_GeoPoint_init_zero, {{NULL}, NULL}, 0}
...
X(a, CALLBACK, SINGULAR, BYTES,    calibration_data,  14) \
...
#define meshtastic_DeviceUIConfig_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   node_name,         6) \
X(a, STATIC,   SINGULAR, INT32,    channel,           7)
#define meshtastic_NodeFilter_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   node_name,         5)
#define meshtastic_NodeHighlight_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   style,             2) \
X(a, STATIC,   SINGULAR, BOOL,     follow_gps,        3)
#define meshtastic_Map_CALLBACK pb_default_field_callback
...
/* meshtastic_DeviceUIConfig_size depends on runtime parameters */
/* meshtastic_NodeFilter_size depends on runtime parameters */
/* meshtastic_NodeHighlight_size depends on runtime parameters */
/* meshtastic_Map_size depends on runtime parameters */
#define MESHTASTIC_MESHTASTIC_DEVICE_UI_PB_H_MAX_SIZE meshtastic_GeoPoint_size
