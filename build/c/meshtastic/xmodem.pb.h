...
#define meshtastic_XModem_init_default           {_meshtastic_XModem_Control_MIN, 0, 0, {{NULL}, NULL}}
#define meshtastic_XModem_init_zero              {_meshtastic_XModem_Control_MIN, 0, 0, {{NULL}, NULL}}
...
X(a, CALLBACK, SINGULAR, BYTES,    buffer,            4)
#define meshtastic_XModem_CALLBACK pb_default_field_callback
...
/* meshtastic_XModem_size depends on runtime parameters */
